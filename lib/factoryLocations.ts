...
export const factoryLocations = {
  ...
  // 신설동/용두동으로 세분화
  "우진모피": { lat: 37.5730, lng: 127.0370, address: "서울특별시 동대문구 용두동" },
  "더시크컴퍼니": { lat: 37.5772, lng: 127.0256, address: "서울특별시 동대문구 신설동" },
  "아트패션": { lat: 37.5772, lng: 127.0256, address: "서울특별시 동대문구 신설동" },
  "좋은사람": { lat: 37.5730, lng: 127.0370, address: "서울특별시 동대문구 용두동" },
  ...
  "조아스타일": { lat: 37.5679, lng: 126.9789, address: "서울특별시 동대문구 이문동" },
  ...
  // 스마일 2 - 장안2동
  "스마일 2": { lat: 37.5668, lng: 126.9783, address: "서울특별시 동대문구 장안2동" },
