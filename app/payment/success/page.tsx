...
export default function PaymentSuccessPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-20 bg-white rounded-xl shadow-md p-8 text-center">
      ...
      <a href="/my-courses" className="inline-block bg-toss-blue text-white rounded-full px-6 py-2 font-bold hover:bg-blue-600 transition-colors mr-2">내 강의실</a>
      <a href="/" className="inline-block bg-gray-200 text-gray-700 rounded-full px-6 py-2 font-bold hover:bg-gray-300 transition-colors">홈으로</a>
    </div>
  );
} 