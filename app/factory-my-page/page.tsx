...
export default function FactoryMyPage() {
  ...
  if (isLoading) {
    return (
      <div className="mx-auto mt-20 max-w-md rounded-lg border border-dg-line bg-white p-8 text-center">
  ...
  return (
    <div className={`${PAGE_CONTAINER_CLASS} py-4 md:py-16 h-full min-h-[500px]`}>
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-8">
        {/* 데스크톱 사이드바: 메뉴만 */}
        <aside className="hidden h-fit w-1/4 min-w-[220px] rounded-lg border border-dg-line bg-white p-6 md:block">
        ...
        {/* 메인 컨텐츠 */}
        <section className="flex-1 rounded-lg border border-dg-line bg-white p-4 md:p-8">
          {selectedMenu === "프로필" && (
            <div>
              ...
              {/* 기본 정보 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">기본 정보</h3>
              ...
              {/* 이미지 관리 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">이미지 관리</h3>
              ...
              {/* 사업 정보 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">사업 정보</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
              ...
              {/* 제작 품목 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">제작 품목</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
              ...
              {/* 설비 정보 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">설비 정보</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
              ...
              {/* 공정 정보 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">공정 정보</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
              ...
              {/* 소개 및 설명 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">소개 및 설명</h3>
              ...
              {/* 연락처 정보 섹션 */}
              <div className="mb-6 md:mb-8">
                <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-gray-800">연락처 정보</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
              ...
              {matchRequests.length === 0 ? (
                ...
                <div className="space-y-3 md:space-y-4">
                  {matchRequests.map((request) => (
                    <div key={request.id} className="rounded-lg border border-dg-line bg-white p-4 transition-colors duration-200 hover:bg-gray-50 md:p-6">
